...
\begin{axis}[
  ...
  symbolic x coords={Coherent,Reduced,Plain,Experiment,Boltzmann},
  xtick=data,
...
\end{axis}
\end{tikzpicture}
\caption{Final $\Csixty$ populations at 99.5 fs. The coherent and reduced uncertainties are reported in the text; the FSSH and experiment values are shown without inferred uncertainties.}
\end{figure}
...
The maximum mean donor--acceptor coherence is 0.426162 at 77.5 fs, showing that the transfer cannot be represented as a sequence of completely incoherent one-way hops. The most active forward channel is $D_2\rightarrow A_1$, with integrated positive flux 0.273903. However, its net signed flux is only 0.029675, whereas its absolute flux is 0.518130. Thus, $D_2\rightarrow A_1$ is the largest exchange channel but not the largest source of net acceptor accumulation.
...
\begin{axis}[
  ...
  width=0.88\textwidth,
  height=4.5cm,
  ylabel={Integrated positive flux},
  symbolic x coords={D2-A1,D2-A3,D1-A3,D1-A2,D3-A2,D3-A1,D4-A3,D4-A2,D3-A3,D4-A1,D2-A2,D1-A1},
  xtick=data,
...
\addplot coordinates {
  (D2-A1,0.273903) (D2-A3,0.216658) (D1-A3,0.185530)
  (D1-A2,0.183401) (D3-A2,0.164615) (D3-A1,0.145326)
  (D4-A3,0.139460) (D4-A2,0.134268) (D3-A3,0.097925)
  (D4-A1,0.092338) (D2-A2,0.084038) (D1-A1,0.079446)
};
\end{axis}
\end{tikzpicture}
\caption{Integrated positive donor-to-acceptor probability fluxes. $D_2\rightarrow A_1$ is the most dynamically active pair.}
\end{figure}
...
\begin{axis}[
  ...
  width=0.88\textwidth,
  height=4.3cm,
  ylabel={Integrated signed flux},
  symbolic x coords={D1-A3,D1-A2,D3-A2,D2-A3,D2-A1,D3-A1,D4-A3,D4-A1,D4-A2,D1-A1,D3-A3,D2-A2},
  xtick=data,
  x tick label style={rotate=45,anchor=east,font=\scriptsize},
  bar width=10pt,
  grid=major,
...
\addplot coordinates {
  (D1-A3,0.072861) (D1-A2,0.053819) (D3-A2,0.049790)
  (D2-A3,0.041704) (D2-A1,0.029675) (D3-A1,0.021268)
  (D4-A3,0.012456) (D4-A1,0.006600) (D4-A2,-0.000708)
  (D1-A1,-0.002978) (D3-A3,-0.003041) (D2-A2,-0.036544)
};
\end{axis}
\end{tikzpicture}
\caption{Integrated signed fluxes. Positive bars contribute net donor-to-acceptor population transfer; negative bars indicate net backflow.}
\end{figure}
